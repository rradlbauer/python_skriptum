...
# Es kann auch ein neues datetime mit konkreten Werten erstellt werden. Die Paremeter sind dabei absteigend Jahr, Monat, Tag, Stunde, Minute, Sekude ...
# Es kann aber auch ein neues datetime nur mit Jahr, Monat, Tag erstellt werden, oder einer anderen Kombination:
neuesDatum = datetime(2010,12,30)
```
...
[Hier geht's zu den weiteren Übungen](../uebungen/UE_13.0_Datum_und_Uhrzeit_Weitere_Uebungen.md)
