...
![VariablenFenster.png](../img/3.0/VariablenFenster.png)
...
![Variablenfenster2.png](../img/3.0/Variablenfenster2.png)
...
![Variablenfenster3.png](../img/3.0/Variablenfenster3.png)

Später werden wir noch viele weitere Arten von Objekten kennenlernen, die wir in Variablen speichern können.

## Übungen
[Hier geht's zu den Übungen](../uebungen/UE_3.0_Variablen.md)
...
[<<](2.1_PythonAlsTaschenrechner.md) &emsp; [>>](3.1_Datentypen.md)
