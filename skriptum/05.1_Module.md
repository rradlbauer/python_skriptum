...
Wenn du dann in einem anderen Script verwenden möchtest, kannst du deine eigene Datei importieren.
...
## Alternative: Modul ohne Neustart neu laden

Wenn du nicht neu starten möchtest, kannst du dein Modul mit `importlib` neu laden:
...
So wird dein Modul neu eingelesen, und du kannst die Änderungen sofort testen.
