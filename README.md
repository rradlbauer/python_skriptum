...
- [2.1 Python als Taschenrechner](skriptum/02.1_PythonAlsTaschenrechner.md)
- [3.0 Ergebnisse zwischenspeichern - Variablen](skriptum/03.0_Variablen.md)
- [3.1 Datentypen](skriptum/03.1_Datentypen.md)
- [4.0 Python Script](skriptum/04.0_Script.md)
- [4.1 Debugger](skriptum/04.1_Debugger.md)
- [5.0 Funktionen](skriptum/05.0_Funktionen.md)
- [5.1 Module](skriptum/05.1_Module.md)
- [6.0 Zeichnen mit der Schildkröte](skriptum/06.0_turtle.md)
- [7.0 Eingabe und Ausgabe](skriptum/07.0_EinAusgabe.md)
- [7.1 Fehlerbehandlung](skriptum/07.1_Fehlerbehandlung.md)
- [8.0 Fälle unterscheiden - bedingte Anweisungen](skriptum/08.0_IfElse.md)
- [9.0 Listen](skriptum/09.0_Listen.md)
- [9.1 Iteration - Anweisungen für alle Elemente einer Liste wiederholen](skriptum/09.1_Iteration.md)
- [9.2 While-Schleife](skriptum/09.2_While_Schleife.md)
